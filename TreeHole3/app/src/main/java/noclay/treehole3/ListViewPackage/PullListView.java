...
//                Log.v(TAG, String.valueOf(realDeltaY));
                // 初始状态下
                if (state == NONE) {
                    if (realDeltaY > 0) {
...
//                        Log.v(TAG, "下拉刷新转变到初始状态");
                ...
                // 可以松手去刷新了
                    ...
                    headView.setPadding(0, -headViewHeight + (int) realDeltaY, 0, 0);
//                    Log.v(TAG, String.valueOf(realDeltaY)+"+"+ String.valueOf(headViewHeight));
...
//        Log.v(TAG, String.valueOf(firstPosition)+" And "+ String.valueOf(listPaddingTop));
        if (direction > 0) {
